class Xstarroll < Formula
  ...
  def install
    ...
    inreplace "sample11", "./xstarroll", "xstarroll"
    inreplace "sample12", "./xstarroll", "xstarroll"
    inreplace "sample13", "./xstarroll", "xstarroll"
    inreplace "sample14", "./xstarroll", "xstarroll"
    inreplace "sample21", "./xstarroll", "xstarroll"
    inreplace "sample22", "./xstarroll", "xstarroll"
    inreplace "sample23", "./xstarroll", "xstarroll"
