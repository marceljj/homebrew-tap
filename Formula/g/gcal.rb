class Gcal < Formula
  ...
  def install
    ...
    system "curl", "-O", "https://manpages.debian.org/trixie/gcal/gcal.1.en.gz"
    system "curl", "-O", "https://manpages.debian.org/trixie/gcal/gcal2txt.1.en.gz"
    system "curl", "-O", "https://manpages.debian.org/trixie/gcal/tcal.1.en.gz"
    system "curl", "-O", "https://manpages.debian.org/trixie/gcal/txt2gcal.1.en.gz"
