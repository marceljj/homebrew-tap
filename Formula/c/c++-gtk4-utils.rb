class CxxGtk4Utils < Formula
  version "2.2.20"
  desc "A lightweight library containing a number of classes and functions for programming GTK4 programs using C++ in POSIX environments"
